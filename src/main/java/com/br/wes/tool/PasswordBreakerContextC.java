...
public class PasswordBreakerContextC implements PasswordBreakerContext {

	private static final Logger LOG = LoggerFactory.getLogger(PasswordBreakerContextC.class);
